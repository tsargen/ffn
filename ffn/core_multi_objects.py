...
class PerformanceStats(object):
    ...
    def _update(self, obj):
        # calc
        self._calculate(obj)
        print ('self.returns_type {}'.format(self.returns_type))
    ...
    def _calculate(self, obj):
        ...
        self.spreadshock = dp.to_spreadshock_series(self.prices, self.returns_type)
...
class SpreadPerformanceStats(object):
    """
    PerformanceStats is a convenience class used for the performance
    ...
    def display(self):
        ...
        print('\nSpread Shocks:')
        data = [
            [fmtp(self.max_spreadshock), fmtp(self.avg_spreadshock),
...
class PricePerformanceStats(object):
    """
    PerformanceStats is a convenience class used for the performance
    evaluation of a price series. It contains various helper functions
    to help with plotting and contains a large amount of descriptive
...
def calc_rolling_spreadshock(spreads, window=60, **kwargs):
    """
    Calculates a rolling spreadshock of a spread series.
    """
    return (spreads.rolling(window, **kwargs).apply(lambda x: calc_max_spreadshock(x, returns)))
